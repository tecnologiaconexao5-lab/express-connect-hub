...
async function criarTabela() {
  console.log('=== CRIANDO TABELA pagamentos_prestadores ===\n');
  
  const testRecord = {
    id: '00000000-0000-0000-0000-000000000001',
    prestador_id: '00000000-0000-0000-0000-000000000000',
    prestador_nome: 'TESTE CRIACAO',
  ...
  console.log('ERRO:', error?.message || 'SEM ERRO');
...
criarTabela().catch(e => console.log('ERRO:', e.message));