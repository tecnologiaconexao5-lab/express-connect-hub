...
const regex = /<DialogTrigger asChild>[\s\S]*?<Button className="bg-orange-600 hover:bg-orange-700 text-white"><Plus className="w-4 h-4 mr-2"\/> Nova Despesa<\/Button>[\s\S]*?<\/DialogContent>/g;
